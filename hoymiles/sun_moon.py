...
# Licensing and copyright: see https://github.com/peterhinch/micropython-samples/tree/master/astronomy/README.md
...
import time
from math import sin, cos, sqrt, fabs, atan, radians, pi
